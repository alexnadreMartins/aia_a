  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        color: const Color(0xFF000000), // Pure black panel
      ...
      child: SingleChildScrollView(
        child: Column(
          ...
          children: [
            Text(isEditingContent ? "IMAGE CROP" : "FRAME GEOMETRY", 
                style: TextStyle(fontWeight: FontWeight.w600, color: isEditingContent ? Colors.orangeAccent : Colors.blueAccent, fontSize: 11, letterSpacing: 0.5)),
